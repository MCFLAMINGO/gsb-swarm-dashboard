...
export const RAILWAY_AGENTS: Agent[] = [
  {
    ...
    acpAgentId: "xgu49hcj2bszls4ld5q18x4w",
    acpJobUrl: "https://app.virtuals.io/acp/agents/xgu49hcj2bszls4ld5q18x4w",
  ...
  },
  {
    ...
    totalEarned: 0,
    lastActiveAt: new Date().toISOString(),
    acpAgentId: "aq6du2zjiz9iekvewllqtn1i",
    acpJobUrl: "https://app.virtuals.io/acp/agents/aq6du2zjiz9iekvewllqtn1i",
    x402Endpoint: "https://gsb-swarm-production.up.railway.app/api/fire-job",
    webhookUrl: "/api/webhook",
    acpCategory: "Analysis / Research",
  ...
  },
  {
    ...
    totalEarned: 0,
    lastActiveAt: new Date().toISOString(),
    acpAgentId: "sxlj5ptb50xuu1u2goe7bcai",
    acpJobUrl: "https://app.virtuals.io/acp/agents/sxlj5ptb50xuu1u2goe7bcai",
    x402Endpoint: "https://gsb-swarm-production.up.railway.app/api/fire-job",
    webhookUrl: "/api/webhook",
  ...
  },
  {
    ...
    totalEarned: 0,
    lastActiveAt: new Date().toISOString(),
    acpAgentId: "ueatopeufdiy9d7ucrjxmkbl",
    acpJobUrl: "https://app.virtuals.io/acp/agents/ueatopeufdiy9d7ucrjxmkbl",
...
export const CEO_AGENT: Agent = {
  ...
  totalEarned: 0,
  lastActiveAt: new Date().toISOString(),
  acpAgentId: "itrtj5b95z14av53qoubqwcu",
  acpJobUrl: "https://app.virtuals.io/acp/agents/itrtj5b95z14av53qoubqwcu",
  x402Endpoint: "https://gsb-swarm-production.up.railway.app/api/fire-job",
  webhookUrl: "/api/webhook",
